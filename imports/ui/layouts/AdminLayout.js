              ...
              <nav className="demo-navigation mdl-navigation mdl-color--black-grey-800">
                {
                  Session.get('maroonuser').type === 'superadmin' ?
                    <div>
                      ...
                      <NavLink className="mdl-navigation__link" to="/admin/organization"><i className="mdl-color-text--blue-grey-400 material-icons" role="presentation">local_offer</i>Organizations</NavLink>
                      <NavLink className="mdl-navigation__link" to="/admin/tickets"><i className="mdl-color-text--blue-grey-400 material-icons" role="presentation">inbox</i>Level</NavLink>
                      ...
                      <NavLink className="mdl-navigation__link" to="/admin/state"><i className="mdl-color-text--blue-grey-400 material-icons" role="presentation">flag</i>State</NavLink>
                      <NavLink className="mdl-navigation__link" to="/admin/district"><i className="mdl-color-text--blue-grey-400 material-icons" role="presentation">report</i>District</NavLink>
